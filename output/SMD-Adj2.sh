...
# Axes label 
set xlabel 'Time [s]'
set ylabel 'Adjoint variable {/Symbol l_2}' offset 1,0,0
...
plot 'bdf0.1.dat' u 1:6 with lines ls 1 title 'h=0.1', \
    'bdf0.01.dat' u 1:6 with lines ls 2 title 'h=0.01', \
    'bdf0.001.dat' u 1:6 with lines ls 3 title 'h=0.001',
