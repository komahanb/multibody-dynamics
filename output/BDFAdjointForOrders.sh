...
solid font 'Sans-Sheriff-Bold,18' lw 2

#set size square
set output 'BDFAdjointOrder.eps'
...
# Axes label 
set xlabel 'Time [s]'
set ylabel 'Adjoint variable {/Symbol l}' offset 1,0,0
...
plot 'sol1.dat' u 1:5 with lines ls 1 title 'BDF1', \
    'sol2.dat' u 1:5 with lines ls 2 title 'BDF2', \
    'sol3.dat' u 1:5 with lines ls 3 title 'BDF3',
